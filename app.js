...
// Health check endpoint (improved for reliability)
// This should respond quickly without depending on other services
app.get('/health', (req, res) => {
  // Simple, fast response for container health checks
  res.status(200).json({
    status: 'ok',
