...
// Initialize Secret Manager client if project ID is available
try {
...
async function initializeApiKeys() {
  ...
  try {
    ...
    if (deepseekApiEndpoint) {
      ...
      console.log('DeepSeek API endpoint configured');
    } else {
      config.deepseekApiEndpoint = "https://api.deepseek.ai";  // Default fallback
    ...
    if (openaiApiEndpoint) {
      ...
      console.log('OpenAI API endpoint configured');
